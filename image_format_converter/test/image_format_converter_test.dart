...
void main() {
  group('ImageFormatConverter', () {
    ...
    test('convertToJpeg: Successfully converts a valid image to JPEG', () {
      ...
      final newJpegBytes = ImageFormatConverter.convertToJpeg(sourceBytes, quality: 50);
      
      expect(newJpegBytes, isNotNull);
    });

    test('convertToPng: Returns null when provided with corrupted/invalid bytes', () {
    ...
    test('convertToPng: Successfully converts an actual JPEG file from disk', () {
      ...
      final Uint8List? pngBytes = ImageFormatConverter.convertToPng(realImageBytes);
